...
$data = mysqli_query($conn, "SELECT * FROM heroes WHERE user_id='$user_id' ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<title>Data Heroes - ML Gallery</title>
...
<div class="container mt-5">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="text-info">Daftar Heroes Anda</h2>
    <div>
      <a href="tambah_heroes.php" class="btn btn-custom">+ Tambah Hero</a>
      <a href="gallery_heroes.php" class="btn btn-outline-info">Lihat Galeri</a>
    </div>
  </div>
        ...
        while ($row = mysqli_fetch_assoc($data)) {
          echo "<tr>
            ...
            <td class='text-center'>
              ...
              <a href='edit_hero.php?id={$row['id']}' class='btn btn-sm btn-warning'>Edit</a>
              <a href='hapus_hero.php?id={$row['id']}' class='btn btn-sm btn-danger' onclick='return confirm(\"Hapus hero ini?\")'>Hapus</a>
            </td>
          </tr>";
          $no++;
        }
      } else {
        echo "<tr><td colspan='8' class='text-center text-secondary'>Belum ada data hero.</td></tr>";
      }
      ?>
      </tbody>
    </table>
